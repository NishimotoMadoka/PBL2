...
// var_dump($friend_article_array);
            ...
            echo    $friend_article['start_time'];
            echo $friend_article['end_time'];
            echo $friend_article['item_name'];
            echo $friend_article['title'];
            echo $friend_article['diary'];
            ?>
        ...
        <p class="article-date"><?= date('Y年m月d日', strtotime($friend_article['post_date'])) ?></p>
